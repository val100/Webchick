...
<jsp:directive.page import="com.agrologic.dao.TableDao"/>
<jsp:directive.page import="com.agrologic.dao.impl.TableDaoImpl"/>
      ...
      <table class ="main" align="center" cellpadding="0" cellspacing="0" border="0" width="100%" style="padding:10px">
        <tr>
          <td>
            ...
            <form id="addForm" name="addForm" action="./addtabletranslate.html" method="post" onsubmit="return validate();">
