...
<%
    ...
    String filename = WebChart.generateXYChart(Long.valueOf(1), section, session, new PrintWriter(out));
    String graphURL = request.getContextPath() + "/servlet/DisplayChart?filename=" + filename;
    ArrayList sectionList = GraphDataSet.getSectionList();
%>
<html>
<head>
...
<body>
<img src="img/top_bar.png" width=1004 height=75 border=0>
<table border=0>
	<tr>
	<td width=170><img src="img/spacer.png" width=170 height=1></td>
	<td>
...
<%				} %>
			...
			<td>
				<input type=image src="img/button_refresh.png" width=80 height=22 name=refresh>
			</td>
		</tr>
		</form>
		</table>
