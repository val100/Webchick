...
<jsp:directive.page import="com.agrologic.dto.TransactionDto"/>
<jsp:directive.page import="com.agrologic.dao.TransactionDao"/>
<jsp:directive.page import="com.agrologic.dao.impl.TransactionDaoImpl"/>
